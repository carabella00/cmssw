...
static bool bookHistos=true; //set to true/false to turn on/off histogram booking internal to the tracking
...
static bool geomTDR=true; // false => newest T14 tracker, true => "TDR" (T5/T6 tracker, D21/D11/D17 CMS geometries)
...
static unsigned int MAXOFFSET=0; //set to 0 to enable regular truncation or 10000 to disable it.
